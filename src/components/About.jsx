...
const About = () => {
  return (
    <div id="aboutme" className="flex flex-col items-center justify-center gap-10">
      ...
      <div className="w-4/5 flex flex-col md:flex-row items-center justify-between lg:gap-10 md:gap-10 gap-6">
        {/* Profile image */}
        <div className="lg:w-3/12 md:w-2/6 w-2/3">
          <img
            src={Profile}
            alt="Anurag Pradhan"
            className="w-full rounded-sm shadow-lg object-contain"
          />
        </div>

        {/* Text content */}
        <div className="lg:w-2/3 max-w-3xl md:w-4/6 lg:text-lg md:text-sm font-medium leading-snug mx-auto text-justify">
          <p>
          ...
          <p className="mt-6">
            I’m excited to keep growing as a developer, taking on new challenges, and building products that make a real difference.
          </p>
        </div>
      </div>
    </div>
